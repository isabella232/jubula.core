...
/**
 * This class represents a GuiDancer runtime exception. As it exends
 ...
 *
 */
public abstract class GDRuntimeException extends RuntimeException {
     ...
     * {@inheritDoc}
     */
    public GDRuntimeException(String message, Integer id) {
        super(message);
        m_id = id;
    }
     ...
     * {@inheritDoc}
     */
    public GDRuntimeException(String message, Throwable cause, Integer id) {
        this(message, id);
        m_causedBy = cause;
    }
     ...
     * {@inheritDoc}
     */
    public GDRuntimeException(Throwable cause, Integer id) {
