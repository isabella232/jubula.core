 ...
 */
public interface IJListImplClass {
     ...
     * @param operator operator
     * @param exists exists */ 
    public void gdVerifyContainsValue(
        String text, 
        String operator, 
        boolean exists);
     ...
     * @param index index
     * @param isSelected isSelected */ 
    public void gdVerifySelectedIndex(
        String index, 
        boolean isSelected);
     ...
     * @param mouseButton mouseButton
     * @param modifierSpecification modifierSpecification
     * @param indexOnly indexOnly */ 
    public void gdDragIndex(
        int mouseButton, 
        String modifierSpecification, 
        int indexOnly);
