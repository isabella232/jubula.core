 ...
 */
public interface IJTabbedPaneImplClass {
    ...
    public void gdVerifySelectedTab(
        String title, 
        String operator, 
        boolean isSelected);
    ...
    /**
     * @param oneIndex oneIndex
     * @param isSelected isSelected */ 
    public void gdVerifySelectedTabByIndex(
        int oneIndex, 
        boolean isSelected);

    /**
     * @param oneIndex oneIndex */ 
    public void gdSelectTabByIndex(
        int oneIndex);

    /**
     * @param oneIndex oneIndex
     * @param isEnabled isEnabled */ 
    public void gdVerifyEnabledByIndex(
        int oneIndex, 
        boolean isEnabled);
     ...
     * @param title title
     * @param operator operator */ 
    public void gdVerifyTextOfTabByIndex(
        int oneIndex, 
        String title, 
        String operator);
     ...
     * @param operator operator
     * @param exists exists */ 
    public void gdVerifyExistenceOfTab(
        String tab, 
        String operator, 
        boolean exists);
