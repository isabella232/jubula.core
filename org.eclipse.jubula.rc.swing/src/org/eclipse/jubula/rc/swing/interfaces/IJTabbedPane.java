...
public interface IJTabbedPane {
    ...
    public void rcVerifySelectedTab(
        String title, 
        String operator, 
        boolean isSelected);
     ...
     * @param isSelected isSelected */ 
    public void rcVerifySelectedTabByIndex(
        int oneIndex, 
        boolean isSelected);

    /**
     * @param oneIndex oneIndex */ 
    public void rcSelectTabByIndex(
        int oneIndex);

    /**
     * @param oneIndex oneIndex
     * @param isEnabled isEnabled */ 
    public void rcVerifyEnabledByIndex(
        int oneIndex, 
        boolean isEnabled);
     ...
     * @param title title
     * @param operator operator */ 
    public void rcVerifyTextOfTabByIndex(
        int oneIndex, 
        String title, 
        String operator);
