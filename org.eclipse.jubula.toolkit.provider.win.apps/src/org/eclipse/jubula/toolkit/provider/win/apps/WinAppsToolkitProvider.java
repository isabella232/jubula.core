 ...
 *******************************************************************************/
package org.eclipse.jubula.toolkit.provider.win.apps;
...
import org.eclipse.jubula.toolkit.provider.win.ToolKitProvider;
...
public class WinAppsToolkitProvider extends ToolKitProvider {
    ...
    private static final String I18N_PROPERTIES = 
        "org.eclipse.jubula.toolkit.provider.win.apps.I18nStrings"; //$NON-NLS-1$
