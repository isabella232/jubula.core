 ...
 * @created Mar 17, 2010
 */
public abstract class AbstractGDEditor extends EditorPart implements IGDEditor,
        ISelectionProvider, ITreeViewerContainer, IGDPart,
     ...
     * @created May 17, 2010
     */
    public class GDEditorDecorationContext implements IDecorationContext {
        /** {@inheritDoc} */
    ...
    private class EditorSelectionChangedListener implements
        ...
        public void selectionChanged(SelectionChangedEvent event) {
            ...
            SelectionChangedEvent selChangedEvent = new SelectionChangedEvent(
                    AbstractGDEditor.this, event.getSelection());
            while (iter.hasNext()) {
    ...
    public final void createPartControl(Composite parent) {
        if (getEditorHelper() == null) {
            setEditorHelper(new GDEditorHelper(this));
        }
     ...
     */
    public void setEditorHelper(GDEditorHelper editorHelper) {
