...
/**
 * Encapsulates the functionality expected of all editors in GUIdancer. This
 * includes locking/unlocking persistent objects and reacting to changes in 
 * GUIdancer's data model.
 * This class can be instantiated and used by any GUIdancer editor.
 *
 * @author BREDEX GmbH
 * @created Oct 22, 2008
 */
public class GDEditorHelper implements ILockedObjects, 
     ...
     */
    public GDEditorHelper(IGDEditor editor) {
        m_editor = editor;
    }
    ...
    public Object getAdapter(Class adapter) {
        if (adapter == ILockedObjects.class 
            || adapter == IGDEditor.class) {
            return this;
        } else if (adapter.equals(IPropertySheetPage.class)) {
            return new GDPropertiesView(true, getEditSupport().getCompMapper());
