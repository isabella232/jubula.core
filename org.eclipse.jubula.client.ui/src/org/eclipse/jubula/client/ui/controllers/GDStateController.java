 ...
 * @created 24.02.2005
 */
public class GDStateController {
    
    /** instance of this class */
    private static GDStateController instance;
     ...
     */
    public static GDStateController getInstance() {
        if (instance == null) {
            instance = new GDStateController();
        }
        return instance;
    }
    ...
    void reactOnChange(IWorkbenchPart part, ISelection sel) {
        ...
        m_lastPart = part;
        m_lastSelection = sel;
        if (!(part instanceof ProblemView)) {
            checkGlobalActions();
        }
