 ...
 *******************************************************************************/
package org.eclipse.jubula.client.ui.contributionitems;
...
import org.eclipse.jubula.client.ui.handlers.StartObjectMappingModeHandler;
...
/**
 * Populates the dropdown list for the "Start Object Mapping Mode" toolbar 
 * item based on currently Running AUTs.
 *
 * @author BREDEX GmbH
 * @created Mar 2, 2010
 */
public class StartObjectMappingModeContributionItem extends
    ...
    private static IContributionItem createItem(AutIdentifier autId) {
        ...
        params.put(StartObjectMappingModeHandler.RUNNING_AUT, autId);
