 ...
 * @created 29.05.2006
 */
public class GDStatusLineContributionItem extends ContributionItem {
     ...
     */
    public GDStatusLineContributionItem(String id) {
     ...
     */
    public GDStatusLineContributionItem(String id, int charWidth) {
        super(id);
