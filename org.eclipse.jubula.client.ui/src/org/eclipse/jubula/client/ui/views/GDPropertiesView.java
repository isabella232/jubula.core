...
import org.eclipse.jubula.client.ui.controllers.propertysources.CapGUIPropertySource.ActionTypeController;
import org.eclipse.jubula.client.ui.controllers.propertysources.CapGUIPropertySource.ComponentNameController;
import org.eclipse.jubula.client.ui.controllers.propertysources.CapGUIPropertySource.ComponentTypeController;
import org.eclipse.jubula.client.ui.controllers.propertysources.CapGUIPropertySource.ParameterNameController;
import org.eclipse.jubula.client.ui.controllers.propertysources.CapGUIPropertySource.ParameterTypeController;
import org.eclipse.jubula.client.ui.controllers.propertysources.CapGUIPropertySource.ParameterValueController;
...
import org.eclipse.jubula.client.ui.provider.contextprovider.GDContextProvider;
...
public class GDPropertiesView extends Page implements IDataChangedListener, 
    IParamChangedListener, ISelectionProvider, IPartClosedListener, 
    ILanguageChangedListener, IPropertySheetPage, IAdaptable {
    
    /**  */
    private static final Logger LOG = 
        LoggerFactory.getLogger(GDPropertiesView.class);
    ...
    private final class PropertiesElementComparer implements IElementComparer {
        ...
        public int hashCode(Object element) {
            ...
            if (element instanceof IPropertyDescriptor 
                    && !(element instanceof GDPropertyDescriptor)) {
        ...
        public boolean equals(Object a, Object b) {
            ...
            if (a instanceof IPropertyDescriptor
                    ...
                    && !(a instanceof GDPropertyDescriptor 
                            || b instanceof GDPropertyDescriptor)) {
    ...
    private GDContextProvider m_contextProvider = 
        new GDContextProvider();
    ...
    /** current editor */
    private AbstractGDEditor m_currentEditor = Plugin.getDefault()
            .getActiveGDEditor();
    ...
    public void createPartControl(Composite parent) {
        ...
        Plugin.getHelpSystem().setHelp(m_treeViewer.getControl(),
                ContextHelpIds.GUIDANCER_PROPERTIES_VIEW);
    ...
    private void reactOnChange(IWorkbenchPart part, 
        ...
        setViewEnabled(!(part instanceof TestCaseBrowser
            ...
            || part instanceof GDPropertiesView
    ...
    /**
     * Workaround for GUIdancer Ticket #3012. Prevents odd cell selection 
   ...
   /**
    ...
    private final class HelpContextListener 
        ...
        public void selectionChanged(SelectionChangedEvent event) {
            ...
            if (ContextHelpIds.PRAEFIX.equals(helpId)) {
                helpId = ContextHelpIds.GUIDANCER_PROPERTIES_VIEW;
            }
    ...
    public void handlePartClosed(IWorkbenchPart part) {
        IWorkbenchPage activePage = Workbench.getInstance()
            .getActiveWorkbenchWindow().getActivePage();
        if (activePage == null) {
            // if GUIdancer was closed
            return;
        }
        IWorkbenchPart activePart = activePage.getActivePart();
        if (activePart == null) {
            // if the last GUIdancer perspective was closed
            return;
        }
        if (part == m_correspondingPart || m_correspondingPart == null
                || part instanceof GDPropertiesView) {
            
            ISelection sel = Workbench.getInstance()
            ...
            if (sel == null 
                    ...
                    || part instanceof GDPropertiesView
                    || activePart instanceof GDPropertiesView) {
     ...
     */
    public void setCurrentEditor(AbstractGDEditor currentEditor) {
     ...
     */
    public AbstractGDEditor getCurrentEditor() {
