...
/**
 * Creates and returns resolutions for GUIdancer-related markers/problems.
 *
 * @author BREDEX GmbH
 * @created 02.06.2008
 */
public class GDMarkerResolutionGenerator implements IMarkerResolutionGenerator {

    /** the logger */
    private static Log log = 
        LogFactory.getLog(GDMarkerResolutionGenerator.class);
                ...
                public void run(IMarker marker) {
                    ...
                    for (Object obj : pm.getElements(
                        ...
                        if (node.getId().equals(
                                Constants.GD_PREF_PAGE_AUTAGENT)) {
                            PreferenceDialog dialog = PreferencesUtil.
                            createPreferenceDialogOn(
                                    null, Constants.GD_PREF_PAGE_AUTAGENT, 
                                    null, null);
