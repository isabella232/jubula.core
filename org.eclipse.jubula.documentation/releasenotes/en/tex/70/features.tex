...
\item For more information on the prerequisites for iOS testing, as well as the information on working with the actions, please refer to the section on iOS in the \bxname{Toolkit} chapter of the documentation. 
\end{itemize}
...
\item Use \bxshell{setData(TEST\_TESTABLE\_TEXT), text} on the instance of the item or component whose text you want to read in your test. 
\end{itemize}
