...
\textbf{p2 update site for IDE integration available in installer}
\begin{itemize}
\item In the \bxname{development} folder of the installation, you can now find a p2 update site containing the Jubula Feature and Launch Integration.
\end{itemize}
