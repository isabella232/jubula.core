...
%% \clearpage
%% \makeatletter
%% \section{Release Notes for \app{} 3.0.2001}
%% \subsection{New features and developments}
%% \makeatother
%% \textbf{Model-based testing}
%% \begin{itemize}
%% \item \app{} has a new modeling perspective. 
...
%% \item You can now record actions directly from a running \gdaut{}. The actions are stored as \app{} \gdsteps{} and can be easily combined with each other to make reusable modules. 
...
%% \begin{itemize}
%% \item The \app{} license mechanism has been changed. 
%% \item The main effect of this is that test executions started from the command line client now no longer need a full \app{} license. 
...
%% \item Testers working with the \app{} client (i.e. creating tests) still need \bxname{specification licenses}, which correspond to the old full licenses. 
...
%% \begin{itemize}
%% \item It is now possible to import and export \gdprojects{} fromt he \gddb{} without starting the \app{} client. 
...
%% \begin{description}
%% \item [The tree view]{ is the \gdomeditor{} known from other versions of \app{}.}
...
%% \item If you save Excel data files and HTML result reports to your workspace, you will be able to view (and edit) them directly in \app{} using the in-place editor. 
%% \end{itemize}
...
%% \begin{itemize}
%% \item We have added a new chapter to the documentation on best practices for working with \app{}.  
%% \end{itemize}
...
%% \begin{itemize}
%% \item In \app{}, you can select multiple items from a list by comma-separating them. 
...
%% \clearpage
%% \section{Release Notes for \app{} Version 2.2.01013}
%% \subsection{New features and developments}

%% \textbf{Cheat sheets}
%% \begin{itemize}
%% \item The tutorials in the user manual have been replaced with Cheat Sheets.
%% \item The Cheat Sheets can be opened from the Help menu in the \app{} client. 
%% \item We recommend that new users of \app{} start with these Cheat Sheets. 
%% \end{itemize}
...
%% \textbf{\app{} variables for use in \gdsuites{}}
%% \begin{itemize}
%% \item \app{} now contains pre-defined test execution variables, which can be used in tests. 
...
%% \begin{itemize}
%% \item \app{} has migrated to Eclipse 3.4. 
%% \item The \app{} plugin can be run in Eclipse 3.4 or Eclipse 3.3. 
%% \end{itemize}

%% \textbf{Support emails}
%% \begin{itemize}
%% \item In the Help menu in \app{}, emails to our support team can now be generated. 
...
%% \textbf{Welcome page}
%% \begin{itemize}
%% \item \app{} now has a welcome page containing information on the example projects, the cheat sheets as well as general information about the program. 
%% \item The welcome screen can be viewed using the Help menu. 
%% \end{itemize}

%% \textbf{Updated example \gdprojects{}}
%% \begin{itemize}
%% \item The example \gdprojects{} have been updated to reflect the best way of working with \app{}. 
%% \item They are described in chapter 2 of the user manual. 
%% \item You can import the sample \gdprojects{} from the \bxname{aut} directory in the \app{} installtion. 
%% \end{itemize}
...
%% \begin{itemize}
%% \item There is a known issue with the opening of context menus with \app{} on Unix systems. 
...
%% \section{Release Notes for \app{} Version 2.1.01018}


%% \subsection{New features and developments}
%% \textbf{Eclipse 3.3 support}
%% \begin{itemize}
%% \item \app{} now supports Eclipse 3.3. 
%% \item The \app{} plugin can be used with the Eclipse 3.2 or 3.3 releases. 
%% \item Java 1.5 or higher is required for the plugin version.
%% \end{itemize}

%% \textbf{Drag and drop actions}
%% \begin{itemize}
%% \item \app{} now supports drag and drop actions on various components. 
...
%% \textbf{Server renamed to \gdagent}
%% \begin{itemize}
%% \item The \app{}-server has been renamed to the \gdagent{} to make its role clearer. 
%% \end{itemize}

%% \textbf{New \gdcase library}
%% \begin{itemize}
%% \item We have improved and expanded the \gdcase{} library installed with \app{}. 
...
%% \item For the internal \gddb{}, no configuration or login to the \gddb{} is necessary. This makes running \app{} easier in the evaluation stages. 
%% \item For the multi-user \gddb{}, the \app{} database scheme is automatically created for the user account at the first login to the \gddb{}. 
%% \end{itemize}

%% %\subsection{Bug fixes and workarounds}
%% \subsection{Other Information}
%% \begin{description}
%% \item [Configuring an SWT \gdaut{}:]{There are two different ways of starting SWT \gdauts{}. At the moment, \app{} cannot start SWT \gdauts{} via \bxname{java.library.path}. Please use \bxname{-Djava.ext.dirs} as a JRE argument in the \gdaut{} configuration to start your SWT \gdaut{}. }
%% \item [Speed in some configurations:]{In some configurations of Linux and RemoteX, Eclipse runs extremely slowly. As \app{} is based on Eclipse, on particular configurations it may also run slowly. }
%% \item []{}
%% \end{description}
%% \section{Release Notes for \app{}Version 2.0.01052}
...
%% \begin{itemize}
%% \item The range of toolkits testable with \app{} has been extended. 
%% \item \app{} can now test Swing, SWT, RCP and Web (HTML) \gdauts{}. 
%% \item For RCP and Web \gdauts{}, certain steps are necessary to configure either \app{} or the \gdaut{} before testing. Refer to the installation manual and the user manual for more details. 
%% \end{itemize}
...
%% \textbf{UTF-16}
%% \begin{itemize}
%% \item \app{} now supports UTF-16 encoding. 
%% \item Refer to the installation manual for recommendations on a \gddb{} for UTF-16.
%% \end{itemize}
%% \textbf{Show log}
%% \begin{itemize}
%% \item If you have configured \app{} to create log files, you can show these in the client via the help menu. 
%% \end{itemize}
...
%% \item[Component Hierarchy]{The component hierarchy has been modified since the previous release. Where possible, \app{}will perform all necessary \gdproject modificatations during the import/conversion process. This will result in, for example, all components that were previously Clickable Components being converted to Graphics Components, as the type Clickable Component no longer exists. Please refer to the Reference Manual for the updated component hierarchy.}
...
%% \item [Extending \app{}]{There are new procedures for extending components and creating your own new components. Refer to the extension manual for details. }
...
%% \section{Release Notes for \app{}Version 1.2.02026}
%% \subsection{New Features and Developments}
...
%% \section{Release Notes for \app{}Version 1.2.01031}
%% \subsection{Important advice}
%% It is, as always, strongly recommended that you back up all projects (by exporting to XML) as well as any Implementation Classes you may have (both source and guidancerConfig.xml) before upgrading to this version of \gd.
%% \subsection{New Features and Developments}
%% \textbf{Simplified Installation}
%% \begin{itemize}
%% \item Tools such as the \app{} Configuration tool and the License Manager can now be started directly from the installer.
%% \end{itemize}
...
%% \begin{itemize}
%% \item Log files can now be accessed directly from the \jbclient.
%% \item This feature is only available when file-based logging is enabled.
%% \item Both Client and Server (when connected to a GDServer) logs are available from the \app{}\bxname{Help} menu.
%% \end{itemize}
%% \textbf{Eclipse 3.2}
%% \begin{itemize}
%% \item \app{}now uses and supports Eclipse 3.2.
%% \item This plugin version does not support Eclipse 3.1 or lower.
%% \end{itemize}
%% \textbf{Testcase Template and Guide}
%% \begin{itemize}
%% \item Reusable Testcases and a usage Guide are now included in the \app{}installation.
%% \item The Testcase Template Guide can be found with the rest of the \app{}documentation.
...
%% \item See the \bxname{Shortcuts} section of the \app{}Reference Manual.
%% \end{itemize}
%% \textbf{Improved Problem View}
%% \begin{itemize}
%% \item The \app{}Problem View has additional support for identification and resolution of common problems, such as connection to a GDServer for which no AUT Configuration is currently defined.
%% \end{itemize}

%% \subsection{Other Information}
%% \begin{description}
%% \item[Implementation Classes and Internationalization]{Internationalization strings for \app{}have been separated into compSystemStrings.properties (which contains all strings related to the component system) and guidancerStrings.properties (which contains strings specifically related to \gd). This separation will require users with their own Implementation Classes to move all internationalization strings for these classes to \emph{compSystemStrings.properties}.}
%% \end{description}
%% \begin{description}
%% \item["Could not restore workbench layout." Error]{You may encounter this error if you use the same workspace for \app{}1.2 as you did for \app{}1.1. If you receive this error message, click \bxshell{OK} to close the message window, then click \bxmenu{Window}{Reset Perspective}{} to solve the problem.}
%% \end{description}
%% \begin{description}
%% \item[Separation of User Manual and Reference Manual]{The \bxname{References} section of the \app{}User Manual has been removed and is now available as a separate document: The \app{}Reference Manual.}
%% \end{description}
%% \begin{description}
...
%% \section{Release Notes for \app{}Version 1.1.02026}
%% \subsection{New Features and Developments}
%% \textbf{Vastly Improved Performance}
%% \begin{itemize}
%% \item Amount of time required for various operations (such as opening and saving of \gdcases) has been greatly reduced.
...
%% \section{Release Notes for \app{}Version 1.1.02016}
%% \subsection{New Features and Developments}
...
%% \item See the \emph{References -> Actions And Parameters} section of the \app{}Manual for specific information.
%% \end{itemize}
...
%% \item See the \emph{Tasks -> Testing without the user interface} section of the \app{}Manual for further information.
%% \end{itemize}

%% \textbf{Supported Java versions}
%% \begin{itemize}
%% \item \app{}now officially supports strictly \gdaut{}s compiled with Java 1.4.1 or higher.
%% \item \app{}is also not officially tested with Java 1.6.
%% \end{itemize}
...
%% \section{Release Notes for \app{}Version 1.1.02002}
%% \subsection{Bug fixes and workarounds}
...
%% \section{Release Notes for \app{} Version 1.1}

%% \subsection{Important advice}
%% If you have previously used \app{} and wish to continue using your \gdprojects{} and database, please follow these instructions to ensure that your \gdprojects{} can be used in the new version. 
%% \begin{enumerate}
%% \item In your old \app{} client, export your \gdprojects{} out of the database. 
...
%% \end{enumerate}
%% These steps are necessary due to changes in the \app{} client which will not otherwise be compatible between versions. 
...
%% \app{} has undergone some changes to the user interface. The icons have been improved. For information on any new icons, and to see what they mean, consult the \bxcaption{Icons} section in the References chapter of the handbook.

%% \textbf{Changes to preference pages}

%% \begin{itemize}
%% \item The preferences pages have been extended to include more preferences. 
%% \item See the \app{} handbook and the preference pages themselves for more information. 
%% \end{itemize}
...
%% \item You can also set environment variables to be used in \app{}. 
...
%% \clearpage 
%% \section{Release Notes for \app{} Version 1.0.64}
%% \begin{itemize}
...
%% \begin{itemize}
%% \item Multilingual testing is now possible with \app{}.
...
%% \begin{itemize}
%% \item \app{} now allows you to execute tests without the user interface.
...
%% \begin{itemize}
%% \item Text fields in \app{} (e.g. in the \gdpropview{}) now offer help when you are entering values.
...
%% \begin{itemize}
%% \item \app{} now supports more actions and offers more parameters. 
...
%% \begin{itemize}
%% \item You can now search \app{} browsers and editors via:\\
%% \bxmenu{Edit}{Search}{}.
%% \end{itemize}
...
%% \textbf{Status Bar}
%% \begin{itemize}
%% \item The status bar is now at the bottom right of the \app{} client.  
%% \end{itemize}

%% \clearpage
%% \section{Release Notes for \app{}Version 1.0.03}
%% \subsection{New Features and Developments}
%% \begin{description}
...
%% \subsection{Other Information}
%% \begin{description}
%% \item[Java Policies]{If the \gdaut uses a security manager (or, in some cases, a Java Policy), please be aware that the \app{}service component requires permission to create and use ClassLoader instances. Most policies will not permit this action for security reasons. The service component uses the ClassLoader to separate the program code used to inspect the \gdaut from the \gdaut itself as much as possible. 

%% To grant the necessary permission, please use the following policy snippet (please use a personal installation directory instead of  the \app{}installation directory). Please also be aware that additional line breaks have been inserted in the following snippet. 
...
%% \section{Release Notes for \app{}Version 1.0.02}

%% \subsection{New Features and Developments}
%% \begin{description}
%% \item[Mac OS and Unix Platforms]{\app{}on Mac OS and Unix has now been tested; the installation for these operating systems is included in this release. } 
%% \item [Eclipse Plugin License Error fixed]{In Version 1.0, starting the \app{}
...
%% \item [Opening Context-Sensitive Menus using the Keyboard]{As an alternative to performing a right-click, \app{}supports standard keyboard-shortcuts to open context-sensitive menus, e.g. \bxkey{Shift+F10} in Windows, and \bxkey{Ctrl+Space} in Mac OS.  }
...
%% \subsection{New Features and Developments}
%% \begin{description}
%% \item[AUT Activation Option]{Some \gdauts may need activating before testing can begin, especially those running on the same machine as the \app{}client. \app{}
...
%% \subsection{Functional Issues}
%% \begin{description}
%% \item[Mac OS and Unix Support]{As support for \app{} on Mac OS and Unix operating systems is still under
