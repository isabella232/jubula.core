\textbf{autrun directory has changed}\\
\begin{itemize}
\item The \bxname{autrun} application has been moved from its own directory in the installed version to within the \bxname{server} folder. The \bxname{autrun} 
directory no longer exists.
\item Scripts using the \bxname{autrun} option will have to be adjusted to reflect this change.
\end{itemize}
