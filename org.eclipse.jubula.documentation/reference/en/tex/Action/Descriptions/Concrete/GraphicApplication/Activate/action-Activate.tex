...
\label{activate}
\begin{itemize}
\item When the \jb{} client and \gdserver are running on the same computer, you may need to bring the \gdaut{} into focus before a test can begin.
...
\item \jb{} realises this action by clicking in the location indicated in the \bxname{activation method} parameter.
