...
\begin{itemize}
\item Use this action to send a key combination to a dialog that is not supported by \gd{} (e.g. file choosers). 
\item \gd{} can send a keystroke to these dialogs, but cannot check if it have arrived. 
