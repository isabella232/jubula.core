...
\begin{itemize}
\item Use this action to send a key combination to a dialog that is not supported by \jb{} (e.g. file choosers). 
\item \jb{} can send a keystroke to these dialogs, but cannot check if it have arrived. 
