...
\begin{itemize}
\item Use this action to input text into dialogs that are not supported by \gd{} (e.g. file choosers). 
\item \gd{} can send keystrokes to these dialogs, but cannot check if they have arrived. 
