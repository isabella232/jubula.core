...
\begin{itemize}
\item Use this action to input text into dialogs that are not supported by \jb{} (e.g. file choosers). 
\item \jb{} can send keystrokes to these dialogs, but cannot check if they have arrived. 
