% CAP description for Menu Bar --> Verify Exists By Indexpath --> Indexpath
\begin{itemize}
\item Use this parameter to specify the menupath to the item you want to check.
\item Enter the menupath as an indexpath.
\item For example, if you want to check the existence of the seventh option in the first menu, then enter \bxshell{1/7} as a parameter.
