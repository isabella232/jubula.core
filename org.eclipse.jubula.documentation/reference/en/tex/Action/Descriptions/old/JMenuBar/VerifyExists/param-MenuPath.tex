...
\bxwarn{\app{} only does the check on the final item in the menupath (e.g. File/Import/\textbf{Picture}). If a menu item before that is missing, it produces an action error. }
