...
\item Every Swing component has properties (attributes).
\item These can include the text size, the size (width/height) of the component, the color etc.
\item Sometimes it is required that a test checks these properties. 
\item Checking properties is a more complex process than other actions. 
...
\end{itemize}
\bxtipp{If the property is \bxname{private}, it cannot be checked, as the remote control has no access to it.}
