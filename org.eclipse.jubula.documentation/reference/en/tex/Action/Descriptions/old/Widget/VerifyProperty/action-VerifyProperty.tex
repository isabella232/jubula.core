...
\item Checking properties is a more complex process than other \gd{} actions. 
...
\end{itemize}
\bxtipp{If the property is \bxname{private}, it cannot be checked, as \gd{} has no access to it.}
