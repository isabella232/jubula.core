% CAP description for Graphics Component --> Context Menu by Indexpath (Specify Position) --> y-position
...
%% \item Using the units parameter, you can specify whether the value should be in pixels or in percent. 
