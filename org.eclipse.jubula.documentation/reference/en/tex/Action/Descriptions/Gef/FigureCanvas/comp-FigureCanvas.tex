...
\item Testing GEF components in \gd{} involves mapping this figure canvas and locating the figures based on their textpath. 
...
\item The figure canvas itself contains various items which can be addressed by \gd{}. 
...
\item Connection anchors. These are the points where connections join to figures. In \gd{}, connection anchors are considered as figures. As such, they can be addressed (clicked, checked etc) using a textpath. 
\end{itemize}
