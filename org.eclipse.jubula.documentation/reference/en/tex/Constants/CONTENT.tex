...
\index{Indices}
Many of the \jb{}actions use parameters for which you need to enter a ''path'' (e.g. menupaths, a path through a tree etc.) or a ''list'' (e.g. to select multiple items from a list or combo box).
