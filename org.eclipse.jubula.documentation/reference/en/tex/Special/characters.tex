\jb{} has a few symbols with a special function (\bxfigref{specialchars}). If you want to use these symbols as a part of a text entry or verification, you must mask them with a backslash. 
