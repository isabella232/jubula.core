...
\item They are relative to the \gdaut{} \bxname{working directory}, if you have entered one. 
\item If no \gdaut{} \bxname{working directory} is given, these paths are relative to the ''server'' directory. 
\end{itemize}
...
\textbf{Paths to screenshots taken with the \bxname{take screenshot} actions}\\
\begin{itemize}
\item When you take a screenshot in your test, you must specify a place to save the screenshot. 
\item Paths you enter are relative to the \gdaut{} \bxname{base directory}, if one has been specified. Otherwise, they are relative to the ''server'' directory.
...
\item If you execute a remote command, the root directory for the relative path is the \gdaut{} \bxname{working directory}, if you have defined one. If not, the default root directory is the ''server'' directory. 
\end{itemize}
