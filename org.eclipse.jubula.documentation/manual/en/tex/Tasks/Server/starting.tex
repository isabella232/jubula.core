...
\bxtipp{The \gdagent{} is started by default without a console. If you want to see the console, you must adapt the \bxname{autagent.ini} file. In the -vm parameter, use \bxname{java} instead of \bxname{javaw} to see the console.}
