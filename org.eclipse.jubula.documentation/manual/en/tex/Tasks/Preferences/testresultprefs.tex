...
\item Decide whether you want all test runs or no test runs to be marked as relevant, or whether you want to be prompted each time. Non-relevant test results are not exported with the \gdproject{}, are not considered for any BIRT reports \bxpref{TasksBIRT} and do not save details to be reported to external ALM repositories \bxpref{TasksALMReport}. 
