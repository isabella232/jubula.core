...
\subsubsection{Showing/hiding execution time in the test result view}
...
\bxname{General - Appearance - Label Decorations}.\\

On this preference page, you can activate / deactivate the \bxname{Test Result Duration Decorator}.
