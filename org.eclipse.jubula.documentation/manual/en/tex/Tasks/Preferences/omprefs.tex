...
\item Configure a keystroke to refresh a web application. This option can help with dynamic web \gdauts{}. Refreshing the components in the  \gdaut{} allows \gd{} to find new components added since the last refresh. There is also a \gdstep{} you can use to achieve the same effect in your tests.  
\end{enumerate}
