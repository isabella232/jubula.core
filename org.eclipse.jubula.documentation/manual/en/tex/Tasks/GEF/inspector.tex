...
The GEF \gdinspector in  the \app{} client allows you to collect information about the textpath to an item from within your RCP \gdaut{}. For many of the actions on GEF figures, you will need to know the textpath. Using the \app{} accessibility plug-in will mean that the textpaths will be easier to read without the inspector \bxpref{gefaccess}. 
