...
The GEF \gdinspector in  the \gd{} client allows you to collect information about the textpath to an item from within your RCP \gdaut{}. For many of the actions on GEF figures, you will need to know the textpath. Using the \gd{} accessibility plug-in will mean that the textpaths will be easier to read without the inspector \bxpref{gefaccess}. 
...
\item In the GEF \gdinspector{}, the path to the item will be shown. If the code for your \gdaut{} uses the accessibility code from \gd{}, then the textpath will be less complex and more readable. 
