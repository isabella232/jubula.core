There is a complete extension mechanism to allow you to add new components and new actions to use in your tests. The \bxname{Extension Manual} provides more information on this. 
