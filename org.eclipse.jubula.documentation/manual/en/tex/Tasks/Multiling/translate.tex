...
%% \bxwarn{At the moment, \jb{} only allows the same number of data sets for each language. Deleting a row in one language will delete it in all of the languages for this instance of the \gdcase{}. }
