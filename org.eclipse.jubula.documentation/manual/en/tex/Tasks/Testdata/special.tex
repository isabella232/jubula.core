...
Some symbols have a special meaning in \gd{}. If you want to use the symbol without the special function, you have to \bxname{escape} it. The symbol to negate any special function of the following symbol is a backslash: ($\backslash$). 
