...
Some symbols have a special meaning in \app{}. If you want to use the symbol without the special function, you have to \bxname{escape} it. The symbol to negate any special function of the following symbol is a backslash: ($\backslash$). 
                          
See the Reference Manual (\bxextref{\app{}efman}{ref,specialchar}) for more details on special symbols and escaping them.
