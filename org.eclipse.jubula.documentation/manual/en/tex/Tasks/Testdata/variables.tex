...
\bxwarn{After entering or changing an environment variable, you will need to restart \app{}. Environment variables are only read from the machine on which the client part of \app{} is running, not from the machine where the \gdagent{} is running.}
