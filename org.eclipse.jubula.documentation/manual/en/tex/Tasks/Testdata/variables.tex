...
\begin{itemize}
\item \gd{} lets you store values from the \gdaut{} to use later.
...
\item Working with the \gd{} pre-defined variables \bxpref{TasksPredefinedVariables}.
\end{itemize}
...
\item Using the pre-defined \gd{} variables in tests \bxpref{TasksPredefinedVariables}
\end{itemize}
...
\gd{} lets you add variables to your operating system, which can be used in your tests. 

You will need to set environment variables which have the form:\\

\bxshell{GDUDV\_<variablename>}\\

\bxname{GDUDV} stands for \bxcaption{\gd{} user-defined variable}. 
...
\bxwarn{After entering or changing a system variable, you will need to restart \gd{}.}

Your system administrator will be able to help you with operating-system specific ways of setting environment variables. 



\subsubsection{Using the \gd pre-defined test execution variables}
\label{TasksPredefinedVariables}
\index{Variables!Pre-defined}
\index{Predefined Variables}

\begin{enumerate}
\item \gd{} contains pre-defined test execution variables which you can use in your tests. 
\item The following variables are automatically initialized when executing a \gdsuite{}:
 ...
 \item [GD\_CLIENTVERSION:]{The version of the \gd{} client you are using.}
