...
\bxwarn{After entering or changing a system variable, you will need to restart \app{}.}
...
\item The following variables are automatically initialized when executing a \gdsuite{}:
 ...
 \item [GD\_AUTSTARTER:]{The hostname for the \gdagent{} the test is running on.}
 \item [GD\_PORTNUMBER:]{The port number for the \gdagent{} the test is running on.}
 \item [GD\_AUT:]{The \gdaut{} name.}
 \item [GD\_AUTCONFIG:]{The \gdaut{} configuration name.}
 \item [GD\_CLIENTVERSION:]{The version of the \app{} client you are using.}
...
\end{enumerate}
\bxtipp{For a list of language codes, see the section in the reference manual (\bxextref{\app{}efman}{ref,langcodes}) for details. }
