...
\bxwarn{In order to perform a this action, all \gdcases{} to be changed must not be in use by anyone else using the \gdproject{} -- you should ensure that this is the case before performing the action, otherwise the action cannot be carried out.}
