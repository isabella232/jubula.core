...
\bxtipp{The Excel file must be configured in a specific way in order for \gd{} to read it \bxpref{TasksConfigureExcel}}.
...
\bxtipp{If you store your Excel files in your workspace, you will be able to open these directly in \gd{} from the navigator view using the in-place editor. }
