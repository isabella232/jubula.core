...
\item Enter concrete values for things that you expect to stay the same, like your choice of \bxname{operator} (i.e. matches, equals) or the click count. Deciding which data not to parametrize is an important decision is test creation. See the Best Practices section for more information on this \bxpref{BPKeywordData}.
