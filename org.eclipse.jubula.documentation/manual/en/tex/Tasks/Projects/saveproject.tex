...
% --------------------------------------------------------
\index{Project!Save As}
\index{Save Project As}
...
\bxtipp{Any test result summaries for the \gdproject{} are not duplicated in the new \gdproject{}. Tests that ran for previous versions of the \gdproject{} are, however, still in the \gddb{} to be used for long term analysis.}
\end{enumerate}
