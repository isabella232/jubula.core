...
The choice of toolkit you make here will determine what actions are available to you to specify your tests. If you choose \bxname{concrete}, you will not be able to specify tests for components specific to e.g. HTML or SWT.
