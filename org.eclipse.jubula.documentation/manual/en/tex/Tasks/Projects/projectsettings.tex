...
\item Specify how often the full test result details \bxpref{TasksReopenTestResul} should be automatically deleted from the \gddb{}.
\end{enumerate}
...
\begin{enumerate}
\item You can change at any time from the \bxname{abstract} or \bxname{concrete} toolkits to a more specific toolkit (e.g. RCP, Web). 
...
You can duplicate an existing \gdaut{} configuration from the \gdproject{} proeprties dialog:
\begin{enumerate}
