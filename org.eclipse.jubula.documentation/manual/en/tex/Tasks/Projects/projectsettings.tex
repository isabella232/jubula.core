...
\item the connection to application lifecycle management (ALM) repositories in this \gdproject{} \bxpref{TasksALMConfigureProject}.
\end{enumerate}
...
\item Edit the markup language used for descriptions in the \gdproject{} \bxpref{TasksEditorAddDescription}. If you edit the markup language after you have entered descriptions, you may need to adapt the description texts to conform to the newly chosen markup language.
...
\item Configure the tracking of changes in this \gdproject{} (see the section later \bxpref{TasksTrackChanges} for details on this).
\end{enumerate}
