...
The first thing to do when you want to work with models in \jb{} is to create an Eclipse Project in which the models will be managed and saved. The \gdproject{} will be saved in your workspace. 
