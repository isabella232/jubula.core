...
\begin{description}
\item [\gdcase{}:]{These are the building blocks of your test. When you generate your model, they become normal \gd{} \gdcases{} \bxpref{WorkingWithTestCases}. Use \gdcases{} to model actions or sequences of actions in your \gdaut{}. }
\item [\gdcase{} reference:]{As with any \gd{} test, \gdcases{} can be reused in other \gdcases{}. Add \gdcase{} references to the \bxname{reused \gdcase{}} area in a \gdcase{} node to indicate that you want to reference a \gdcase{} here. You will need to add a connector line between the \gdcase{} reference and the referencing \gdcase{} in your model.} 
...
\item [Category:]{You can group the \gdcases{} in your model into categories. These will later be generated into \gd{} categories in the \gdtestcasebrowser{} \bxpref{TasksTCCats}. Use categories to organize your \gdcases{}.}
