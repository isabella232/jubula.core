...
\item Configure an \gdaut{} \bxpref{configuringaut} if you want to start the \gdaut{} via \jb{}.  
...
\item Connect to the \gdserver{} \bxpref{connectserv}.
\item Start the \gdaut{} \bxpref{startaut} (either via \jb{} or using the \bxname{gdrun} command). 
