...
\item Configure an \gdaut{} \bxpref{configuringaut} if you want to start the \gdaut{} via \gd{}.  
...
\item Start the \gdaut{} \bxpref{startaut} (either via \gd{} or using the \bxname{gdrun} command). 
