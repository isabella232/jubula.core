You can use \jb{} to test multiple \gdauts{} in one test run.
...
\item The first \gdaut{} can either be started using the \bxname{gdrun} command \bxpref{gdrun} or via an \gdaut{} configuration \bxpref{configuringaut}. Any other \gdauts{} required for the \gdjob{} must have been started with the \bxname{gdrun} command.
\end{itemize}
...
\item The \gdauts{} have all been defined for this \gdproject{Defineaut}.
