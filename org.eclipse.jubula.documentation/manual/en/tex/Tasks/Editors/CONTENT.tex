...
\subsection{Adding descriptions to items in editors}
\gdhelpid{editDescriptionDialogContextId}{Description Dialog}
\gdhelpid{guidancerSpecTestCaseEditorContextId}{Test Case Editor}
\gdhelpid{testSuiteEditorContextId}{Test Suite Editor}
\gdhelpid{guidancerTestJobEditorContextId}{Test Job Editor}
\label{TasksEditorAddDescription}
\input{Tasks/Editors/descriptions}

\subsection{Adding Task IDs to items in editors}
\gdhelpid{guidancerSpecTestCaseEditorContextId}{Test Case Editor}
\gdhelpid{testSuiteEditorContextId}{Test Suite Editor}
\gdhelpid{guidancerTestJobEditorContextId}{Test Job Editor}
\label{TasksEditorAddTaskID}
\input{Tasks/Editors/tasks}
...
\subsection{Replacing \gdcases{} in  editors: Refactoring}
\gdhelpid{guidancerSpecTestCaseEditorContextId}{Test Case Editor}
\gdhelpid{testSuiteEditorContextId}{Test Suite Editor}
\label{TasksReplaceTC}
\input{Tasks/Editors/replace}

\subsection{Saving \gdcases{} from an editor as a new \gdcase{}}
\gdhelpid{guidancerSpecTestCaseEditorContextId}{Test Case Editor}
\gdhelpid{testSuiteEditorContextId}{Test Suite Editor}
\label{TasksSaveAsTC}
\input{Tasks/Editors/saveas}
