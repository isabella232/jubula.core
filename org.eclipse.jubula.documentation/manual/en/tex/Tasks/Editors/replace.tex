...
\item Click \bxcaption{Next} to match the component names for the old and new \gdcases{}, or click \bxcaption{Finish} to replace the selected \gdcases{} with the bare new \gdcase{}, without any component names or parameters transferred. 
\end{enumerate}
