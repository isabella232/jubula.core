...
\bxtipp{To replace a specific \gdcase{} at all / multiple places where it has been reused, use the option available in the \gdsearchresultview{} \bxpref{TasksSearchResultReplaceTC}.}
