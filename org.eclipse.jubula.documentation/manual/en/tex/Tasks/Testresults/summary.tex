A test result summary and full details about the whole test are stored for each test run. Individual \gdsuites{} within a \gdjob{} are counted as one test run each. 
...
\item Each node in the \gdtestresultview{} shows the amount of time taken to execute this node and any parameter values that were used at this node. You can turn these options off in the preferences \bxpref{TasksPrefsDecoration}.
\end{enumerate}
