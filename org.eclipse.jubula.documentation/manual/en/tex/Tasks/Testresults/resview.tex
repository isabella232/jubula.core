...
\item Each node in the \gdtestresultview{} shows the amount of time taken to execute this node. You can turn this option off in the preferences \bxpref{TasksTestResDecorationPrefs}
\end{itemize}

\bxtipp{You can also see screenshots of errors that were taken by \app{} by selecting the screenshot from the tree in the test result tree. You will need to have the \gdimgview{} open to see the screenshot.}
