\jb{}{} tests can be performed as part of an \bxname{Apache Ant} build
process. If you are already familiar with ant tasks, integrating \jb{}{}
...
The above \bxshell{basedir} attribute of the \bxshell{project} element should be set to the \jb{}{}
...
\bxshell{taskdef} section should be left as is. These set up \jb{}{}'s
...
\begin{description}
 ...
 \item{\textbf{autconfig}} The name of the \gdaut{} configuration, as entered
  ...
  \item{\textbf{dburl}} The JDBC URL of the \gddb{} containing your \jb{}{}
  \gdprojects. This option may be omitted, in which case the \gddb{}
  configured using \jb{}'s configuration tool will be used.
