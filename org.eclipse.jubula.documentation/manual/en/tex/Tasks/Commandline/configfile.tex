...
<configuration>
    ...
    <datadir><pathToQADocs>/data</datadir>
    <resultdir><pathToQADocs>/results</resultdir>
</configuration>
\end{verbatim}
\normalsize
\item Save the file as an XML file.
\item This file will be used when you enter the \bxcaption{-c <path to file>} parameter.
\bxtipp{The no-run, quiet mode, no screenshot, no relevance and \bxname{-data} (for the workspace) parameters can only be entered in the command line interface. They cannot be entered in the configuration file.}
