...
\bxtipp{The no-run, quiet mode, no screenshot, no screenshots in reports and \bxname{-data} (for the workspace) parameters can only be entered in the command line interface. They cannot be entered in the configuration file.}
