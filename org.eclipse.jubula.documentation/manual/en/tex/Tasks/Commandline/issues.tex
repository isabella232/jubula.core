...
Specifying tests with the \GD{}  GUI is necessarily an \emph{interactive}
...
process. \GD{} provides some test actions that are meant for interactive
...
respond. \GD thus ignores interactive actions in this case.
