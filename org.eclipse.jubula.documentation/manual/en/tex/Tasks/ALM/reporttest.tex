...
\item [Report has been cancelled:]{if reporting information was available, but the report was cancelled (i.e. the information was discarded and not reported). You can do this by selecting the option from the context menu.}
\end{description}
...
\item If you do not want to report the test results to an ALM tool, you can discard the reporting information by selecting the option to cancel pending reports from the context menu. This changes the status in the \bxname{ALM Report Status} column  from \bxname{Not yet reported} to \bxname{Report has been cancelled}.
\end{enumerate}
