...
\item configured an \gdaut{} \bxpref{configuringaut} if you want to start the \gdaut{} via \jb{}
...
\begin{itemize}
%\item In the \gdaut{} for which the \gdomm{} was started, the components will be highlighted red.
