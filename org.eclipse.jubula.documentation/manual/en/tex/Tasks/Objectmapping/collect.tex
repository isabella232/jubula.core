...
\bxtipp{The colored dot disappears after saving. It is not a measurement of the component state over time, but only at the moment when the component was collected. You can see how well each component was actually located during a test by looking in the test result reports. Each \gdstep{} provides information on the match heuristic for each component.}
