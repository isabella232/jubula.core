...
\item [Assigned names:]{there are pairs of names that have been mapped to each other. Each technical name can be mapped to one or more component names. This mapping tells \jb{} which actual components you are referring to in your \gdcases{}.}
\end{description}
