...
\begin{itemize}
\item started the \gdserver{} \bxpref{otherportnumber}
...
\item configured an \gdaut{} if you want to start the \gdaut{} via \gd{} \bxpref{configuringaut}
...
\item connected to the \gdserver{} \bxpref{connectserv}
