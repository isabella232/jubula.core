...
%TODO - check names of rcp accessor
\begin{enumerate}
\item Locate the  \app{} installation directory.
\item Extract the content of the \bxname{rcpremotecontrol.zip} folder into the \bxname{plugins} directory for your RCP \gdaut{}.
