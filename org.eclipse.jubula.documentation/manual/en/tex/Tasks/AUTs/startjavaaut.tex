...
English (US) and German (DE) keyboard layouts are supported out-of-the box. If you want to use a different keyboard layout, see the Extension Manual for information on creating keyboard layouts. 
\end{enumerate}
