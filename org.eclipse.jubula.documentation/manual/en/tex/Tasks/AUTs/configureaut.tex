...
\item You can optionally create a working/base directory to store files in. The \gdagent directory of the \jb{} installation is selected as default. To create a base directory elsewhere, browse to and select the location. 
