...
\bxtipp{If you want to start your Java \gdaut{} yourself, and have \app{} connect to it, then use the \bxname{autrun} command to start the \gdaut{} \bxpref{autrun}. In this case, you do not need to create an \gdaut{} configuration.}
