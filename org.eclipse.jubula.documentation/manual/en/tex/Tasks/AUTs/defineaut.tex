...
\bxtipp{If you will be starting your \gdaut{} from \app{}, via an \gdaut{} configuration \bxpref{configuringaut} then you do not need to enter any IDs here.}
...
\item If you want to start this \gdaut{} via \app{}, you can now click \bxcaption{Next} to create an \gdaut{} configuration for this \gdaut{} \bxpref{configuringaut}.
\end{enumerate}
