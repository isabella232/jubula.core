...
The command allows you to start your \gdaut{} independently of \jb{}, on a machine where the \gdagent{} is running. The \jb{} client, when connected to this \gdagent{} will then recognize the running \gdaut{} as a testable application. 
