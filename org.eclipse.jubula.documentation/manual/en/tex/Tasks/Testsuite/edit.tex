...
\bxtipp{The step delay is the time \gd{} leaves between each \gdstep{} during test execution. The default is 0 milliseconds. }
...
\item Choose a default reentry type for each of the four error types in \gd{} from the combo-boxes. 
