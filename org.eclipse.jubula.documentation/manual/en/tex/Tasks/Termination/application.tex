...
Once the \gdsuite{}, \gdaut{} and \gdserver{}  have been stopped or disconnected, 
make sure any changes are saved and select: \\ \bxmenu{Project}{Exit}{}. 

\subsection{Stopping the \gdserver}
\gdhelpid{problemViewContextId}{Problem View}
\begin{itemize}
\item Stop the \gdserver{} by selecting: \\ \bxmenu{Start}{Programs}{\jb{}{}} \\
and then \bxcaption{Stop \gdserver{}} 
