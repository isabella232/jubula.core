...
If you are working in a multi-user environment, or if you are working on multiple editors at once, \app{} may lock the editors. This is to secure the editors so that conflicting changes do not take place. You will be able to save changes in your editor once the changes by the other tester or in the other editor have been saved. 
