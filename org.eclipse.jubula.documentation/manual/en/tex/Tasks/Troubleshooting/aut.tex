...
\begin{itemize}
\item You have not connected to the \gdagent{} \bxpref{TasksAgentConnect}.
...
\item[The JAR given as a classpath does not contain a distinct  main class:]{Check that you have entered a JAR which contains a main class.}
\end{description}
