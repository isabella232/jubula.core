...
\begin{itemize}
\item You have not connected to the \gdserver \bxpref{connectserv}.
...
\textbf{If the \gdaut{} does not appear in the \jb{}unautview{}}\\
If the \gdaut{} does not appear in the \jb{}unautview{} and you are testing an RCP application, make sure that the RCP-Accessor has been installed \bxpref{rcpaut}. 
