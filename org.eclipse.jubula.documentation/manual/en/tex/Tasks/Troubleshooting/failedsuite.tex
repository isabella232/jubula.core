...
\begin{itemize}
\item That the \gdaut{} is in focus and is visible. You can automatically activate the \gdaut{} in the \gdaut{} properties \bxpref{configuringaut}. You can also set your preferences to minimize \gd{} when test execution begins \bxpref{gdprefs}. 
