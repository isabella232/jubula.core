...
\bxtipp{If you will be starting your Java \gdaut{} with the \bxname{autrun} command \bxpref{autrun}, then you can automatically define your \gdaut{} \bxpref{createAUTDef}}
...
\item If you choose RCP, decide whether or not you want to generate names for components in the \gdaut{} which have not been named by your developers \bxpref{RCPgenerate}. We recommend leaving this option checked, as it increases the robustness of your tests. 
...
\bxtipp{If you will be starting your \gdaut{} from the \ite{} (i.e. via an \gdaut{} configuration \bxpref{configuringaut}) then you do not need to enter any IDs here.}
...
\item If you want to start this \gdaut{} from the \ite{}, you can do so in the \gdproject{} properties \bxpref{configuringaut}.
\end{enumerate}
