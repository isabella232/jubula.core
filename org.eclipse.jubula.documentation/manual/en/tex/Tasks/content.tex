...
\section{Working with editors: opening, adding/deleting/renaming items, commenting, adding descriptions, extracting and replacing, reverting changes}
...
\clearpage
\section{Working with code coverage with Java tests}
...
\label{CodeCoverage}
\input{Tasks/CodeCoverage/CONTENT}
\clearpage
\section{Preferences}
...
\input{Tasks/Relative/CONTENT}
\clearpage
\section{Remote Debugging}
\input{Tasks/Debugging/CONTENT}
\clearpage
