...
Once the \gdprojects have been imported, open the \bxname{samples} \gdproject{}. Connect to the embedded \gdagent \bxpref{Agent}, and start the \gdaut{} \bxpref{startaut}. 
