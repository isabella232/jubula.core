...
in the \gd{} installation directory under the subdirectory:\\
\bxname{examples/projects}. 

You can import the \gdproject{} into the \gd{}-client as follows:
\begin{enumerate}
\item Select:\\ \bxmenu{Project}{Import}{}.
\item Browse to the \bxname{examples/projects} directory in the \gd{} installation directory. 
...
\gd during test execution. This can be done via :\\
