...
If you do not have write privileges in the installation directory, you must create a workspace directory for the meters application and enter this workspace in the \gdaut{} configuration for meters. In the \bxname{AUT Arguments} field, enter: \bxshell{-data <path to workspace>}.

%% \bxname{/examples/Samples.zip}\\
%% You will need to take the following steps to be able to run the meters tests:
%% \begin{enumerate}
%% \item Open the Workspace Perspective:\\
%% \bxmenu{Window}{Open Perspective}{Workspace}
...
%% \item Browse to the installation directory and then to the
...
%% \item If you do not have write privileges in the installation directory, you must also create a workspace for the meters application and enter this workspace in the \gdaut{} configuration for meters. In the \bxname{AUT Arguments} field, enter: \bxshell{-data <path to workspace>}.
%% \end{enumerate}
