...
\begin{enumerate}
\item Open the \gd{} Workspace Perspective:\\
\bxmenu{Window}{Open Perspective}{\gd{}Workspace}
...
\item Browse to the \gd{} installation directory and then to the
...
\item If you do not have write privileges in the \gd{} installation directory, you must also create a workspace for the meters application and enter this workspace in the \gdaut{} configuration for meters. In the \bxname{AUT Arguments} field, enter: \bxshell{-data <path to workspace>}.
\end{enumerate}
