...
\begin{enumerate}
\item Open the \jb{} Workspace Perspective:\\
\bxmenu{Window}{Open Perspective}{\jb{}Workspace}
...
\item Browse to the \jb{} installation directory and then to the
...
\item If you do not have write privileges in the \jb{} installation directory, you must also create a workspace for the meters application and enter this workspace in the \gdaut{} configuration for meters. In the \bxname{AUT Arguments} field, enter: \bxshell{-data <path to workspace>}.
\end{enumerate}
