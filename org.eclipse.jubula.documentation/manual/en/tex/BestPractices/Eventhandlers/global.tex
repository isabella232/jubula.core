When automated tests are running, it is important to ensure that an error in the test will not result in the rest of the test not running. To do this, the \gd{} team adds general \gdehandlers{} to each use case, at the very top level of the use case. 
