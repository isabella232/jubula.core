...
There are four types of area in the \gd{} user interface:
\bigskip
...
Because \gd{} contains user interface elements whose contents change depending on what is selected, we use a color coding system to distinguish between areas used for specification and execution. 
