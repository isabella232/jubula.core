...
There are five perspectives in \jb{}{}: 
\begin{itemize}
\item Specification
...
\caption{\jb{} Execution Perspective}
...
\caption{\jb{} Modeling Perspective}
\label{modelperspective}
\end{figure}

\clearpage

\subsection{The \jb{} workspace perspective}
...
In the workspace perspective (\bxfigref{workspaceperspective}), you can view the \gdprojects{} and files in your \jb{} workspace. The workspace perspective contains the following:
...
\caption{\jb{} Workspace Perspective}
\label{workspaceperspective}
\end{figure}
\clearpage

\subsection{The \jb{} reporting perspective}
\index{Perspective!Reporting}
\index{Reporting!Perspective}
\index{Views!Test Result Summary}
\index{Test Result Summary View}
In the reporting perspective, the only view is the \gdtestsummaryview{}. You can see an overview of all tests that have run in this \gddb{} and can generate \jb{} BIRT reports from the perspective. 

\begin{figure}
\includegraphics[width=12.5cm]{Userinterface/Editors/PS/reportingperspective}
\caption{\jb{} Reporting Perspective}
