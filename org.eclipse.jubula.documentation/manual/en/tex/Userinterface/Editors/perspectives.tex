...
There are five perspectives in \GD{}: 
\begin{itemize}
\item Specification
...
\caption{\GD Specification Perspective}
\label{clientwindow}
\end{figure}
...
\caption{\GD Execution Perspective}
...
\caption{\GD Modeling Perspective}
\label{modelperspective}
\end{figure}

\clearpage

\subsection{The \gd{} workspace perspective}
...
In the workspace perspective (\bxfigref{workspaceperspective}), you can view the \gdprojects{} and files in your \gd{} workspace. The workspace perspective contains the following:
...
\caption{\GD Workspace Perspective}
\label{workspaceperspective}
\end{figure}
\clearpage

\subsection{The \gd{} reporting perspective}
\index{Perspective!Reporting}
\index{Reporting!Perspective}
\index{Views!Test Result Summary}
\index{Test Result Summary View}
In the reporting perspective, the only view is the \gdtestsummaryview{}. You can see an overview of all tests that have run in this \gddb{} and can generate \gd{} BIRT reports from the perspective. 

\begin{figure}
\includegraphics[width=12.5cm]{Userinterface/Editors/PS/reportingperspective}
\caption{\GD Reporting Perspective}
