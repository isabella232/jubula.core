...
The \gdprobview{} is by default at the bottom of the specification perspective, under the editor area. The \gdpropview{} helps you to work with \gd{} by giving you information, warnings and errors. Double-clicking on a message will either carry out the necessary action or open a dialog/editor to sort out the problem, if this is possible. 
