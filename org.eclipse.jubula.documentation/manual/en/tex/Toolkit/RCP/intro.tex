...
When you select RCP as the \gdproject{} toolkit, the library \gdprojects{} \bxname{unbound\_modules\_concrete}, \bxname{unbound\_modules\_swt} and \bxname{unbound\_modules\_rcp} are automatically reused in your \gdproject{}. The actions in these libraries are described in the reference manual \bxextref{\gdrefman}{ref,actparam}.
