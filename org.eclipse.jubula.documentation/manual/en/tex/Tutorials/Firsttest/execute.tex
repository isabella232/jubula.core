...
and then \bxname{\gd{} preferences}. 
\item Make sure that the option  to minimize \gd{} while you are executing a \gdsuite{} is selected. This means that you can see the \gdaut{} when the test starts, and that there will be no problems if the \gdaut{} was behind the \gd{} client. 
