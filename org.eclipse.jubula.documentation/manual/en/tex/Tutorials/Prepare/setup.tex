...
\item If you started the default \gdagent, choose \bxcaption{localhost} as the \gdagent{} host. If you started a different \gdagent, select \bxcaption{add} and add a new \gdagent \bxpref{TasksPrefsAgent}. 
