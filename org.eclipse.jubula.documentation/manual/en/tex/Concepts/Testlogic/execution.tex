...
\gd{} executes tests on the following basis: 
\begin{itemize}
...
\gd{} bases the success of an action on whether it was carried out or not. There are no implicit checks which verify the state of the application to check if the execution of an action actually had an effect. For example, if an action is carried out to click a button, this \gdstep{} will be marked as successful even if the button is disabled. From \gd{}'s perspective, a click was executed on the button component. 
