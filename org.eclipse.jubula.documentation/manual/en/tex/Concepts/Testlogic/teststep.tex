...
\bxtipp{We recommend using the \gdcases{} in the library \gdprojects{} installed with \jb{} instead of writing \gdsteps{}. Using the \gdcases{} from the library \gdprojects{} saves time and improves the flexibility of your tests.}
