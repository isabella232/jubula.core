...
%\item Locate the \jb{} installation directory. 

\item In Unix, start \bxshell{.$\slash$uninstall}.  
\item In Windows, select \bxshell{uninstall} from the \jb{} start menu. 
...
\item Select the options you have completed and then click  \bxcaption{Yes} again to uninstall \jb{}. 
