...
%\item Locate the \gd{} installation directory. 

\item In Unix, start \bxshell{.$\slash$uninstall}.  
\item In Windows, select \bxshell{uninstall} from the \GD start menu. 
...
\item Select the options you have completed and then click  \bxcaption{Yes} again to uninstall \gd{}. 
