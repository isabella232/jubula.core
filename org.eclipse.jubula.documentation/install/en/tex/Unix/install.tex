...
You can install the \gdagent{} (the server component) and the client on different machines if you want to. If this is the case, carry out the installation for the other component (server or \gdagent{}) later. 

To be able to access the manual as a .pdf file and to  print it  out, install the  \app{} documentation. Click \bxcaption{Next}.


\item Choose the directory in which symlinks for \app{} should be created (\bxfigref{figSymlinks}). The directory must be writable by the user installing the program, i.e. a non-adminstrator may use his home directory. Symlinks should be created in a folder contained in  the \$PATH variable.
