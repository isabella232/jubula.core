If you are migrating from an older version of \app{} installed, we recommend that you follow these steps:
...
\bxtipp{The \gddb{} migration assistant will automatically notify you if your \gddb{} scheme is incompatible with the new version. The migration assistant can carry out the \gddb{} migration for you in most cases.}
