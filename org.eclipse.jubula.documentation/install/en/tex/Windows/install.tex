...
\begin{enumerate}
\item Browse to the directory where you saved the setup file when you downloaded \gd{}. 
...
You can view and print this license later. It is saved in the \gd{} installation directory and is called \bxname{license-agreement.txt}. 
...
\bxtipp{Configuration details can also be changed at a later point. The configuration tool is in the  \gd{} start menu folder: \\
