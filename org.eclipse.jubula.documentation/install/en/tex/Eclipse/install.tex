%% Once \GD has been installed on your system as described in previous
...
%% \bxwarn{In order to run \GD as an \bxname{Eclipse} plugin,
...
%% \section{Required plugins to run \gd{} in Eclipse}
%% A list of required plugins to run \gd{} in your Eclipse environment is available on request. 

%% \section{Installing the plugin for Eclipse 3.3}
%% \begin{enumerate}
%% \item Locate the archive named \bxname{gd-plugins.zip} in your \gd{} installation directory. 
...
%% \GD is installed, or only wish to install the plugin for a single
...
%% \begin{enumerate}
%% \item Open the configuration tool from:\\ \bxmenu{\gd{}}{Admin}{GDConfiguration}.
