%% Once \app{} has been installed on your system as described in previous
...
%% \bxwarn{In order to run \app{} as an \bxname{Eclipse} plugin,
...
%% \section{Required plugins to run \app{} in Eclipse}
%% A list of required plugins to run \app{} in your Eclipse environment is available on request. 

%% \section{Installing the plugin for Eclipse 3.3}
%% \begin{enumerate}
%% \item Locate the archive named \bxname{gd-plugins.zip} in your \app{} installation directory. 
...
%% \app{} is installed, or only wish to install the plugin for a single
...
%% \begin{enumerate}
%% \item Open the configuration tool from:\\ \bxmenu{\app{}}{Admin}{GDConfiguration}.
