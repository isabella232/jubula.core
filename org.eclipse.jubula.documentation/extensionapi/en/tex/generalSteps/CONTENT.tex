...
\item Click the \bxcaption{Restart Now} button to perform a restart of \app{},
...
There you have to append \bxshell{,fragment\_id@start} at the end of the
line starting with \bxshell{osgi.bundles=}. Make sure that the bundles are
