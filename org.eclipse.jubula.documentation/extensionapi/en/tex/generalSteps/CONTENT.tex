...
\begin{description}
 ...
 \begin{itemize}
   ...
   \item \bxshell{eclipseProjects\_ExampleSwingExtension.zip} \\
   A \app{} extension supporting \bxshell{JSlider} for Swing including
   client and remote control projects.
   \item \bxshell{eclipseProjects\_ExampleSwingRendererExtension.zip} \\
   A \app{} remote control extension supporting an own graphics component for
   Swing.
 \end{itemize}
