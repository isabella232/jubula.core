...
/**
 * <p>
 * This class is the entry point when using the Robot API. It creates a Robot
 * factory instance. At this point of implementation, the configuration always
 * returns a AWT/Swing factory implementation.
 * </p>
 *
...
public class RobotFactoryConfig {
    ...
    public IRobotFactory getRobotFactory() {
        return new RobotFactoryJavaFXImpl();
    }
}
