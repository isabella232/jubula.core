...
public interface IList {
     ...
     * @param operator operator
     * @param exists exists */ 
    public void rcVerifyContainsValue(
        String text, 
        String operator, 
        boolean exists);
